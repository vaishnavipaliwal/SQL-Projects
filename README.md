# SQL-Project Namma yatri - OLA - UBER Ride Booking App in Bangalore / Business Analysis
...
select*from trips_details4;
select sum (customer_not_cancelled)-1*100.0/sum(searches) from trips_details4;
